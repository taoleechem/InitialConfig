...
*/
void setup_rotation(double ref_xlist[][3],double mov_xlist[][3],int n_list,double mov_com[3],double mov_to_ref[3],double R[3][3],double* E0)
{
	int i, j, n;
	double ref_com[3];
...
void calculate_rotation_rmsd(double ref_xlist[][3],double mov_xlist[][3],int n_list,double mov_com[3],double mov_to_ref[3],double U[3][3],double &rmsd)
{
	double Eo, residual;
	double R[3][3];
...
#endif
void fast_rmsd(double ref_xlist[][3],double mov_xlist[][3],int n_list,double &rmsd)
{
	double R[3][3];
